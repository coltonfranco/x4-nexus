...
const TABS = [
  { to: "/trade", label: "Catalog", icon: BookOpen, exact: true },
  { to: "/trade/supply", label: "Supply Radar", icon: AlertTriangle, exact: false },
  { to: "/trade/routes", label: "Routes", icon: TrendingUp, exact: false },
] as const;
