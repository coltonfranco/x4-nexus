...
const factionsRoute = createRoute({ getParentRoute: () => rootRoute, path: "/factions", component: FactionsPage });
...
const routeTree = rootRoute.addChildren([indexRoute, mapRoute, shipsRoute, waresRoute, factionsRoute, dropsRoute, diplomacyRoute]);
