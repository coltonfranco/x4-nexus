...
- [`data-tiers.md`](data-tiers.md) — ELT pipeline overview; what directories are crawled and why
- [`xml-taxonomy.md`](xml-taxonomy.md) — X4 XML class taxonomy, conventions, coverage gaps, and re-analysis guide
